...
--- Wallpapers
theme.wallpaper = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/moon_moonlight_forest.jpg")
...
theme.border_color_marked = theme.dark_blue
theme.border_color_active = theme.dark_blue
